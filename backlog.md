...
| B-021 | Annotated video + artifacts | done | 0 | FR-CVPL-19, FR-UPLD-15, FR-XPRT-01 | L | B-018, B-020 | Skeleton overlay, plot, upload |
| B-022 | Wire CV pipeline in worker | done | 0 | FR-UPLD-15, FR-UPLD-18 | L | B-011–B-021 | Full pipeline integration |
| B-023 | Phase 0 coaching service | done | 0 | FR-RESL-03, Appendix D | M | — | Claude Sonnet, instructor, mock in tests |
| B-024 | Wire coaching in worker | done | 0 | Status 5.2a | M | B-022, B-023 | processing→coaching→completed |
| B-025 | Thresholds config file | done | 0 | FR-SCOR-00 | S | — | JSON file, named constants |
| B-026 | Results page (frontend) | done | 0 | FR-RESL-01a–05, FR-RESL-08, FR-RESL-10–11, FR-SCOR-09–10 | XL | B-007 | Video, coaching, metrics, disclaimer |
...
| B-030 | Summary metrics computation | done | 0 | FR-HIST-04 | M | B-024 | Write summary_json after completion |
| B-031 | History insights endpoints | done | 0 | FR-HIST-02–03 | M | B-030 | Rolling avg, personal best, global |
| B-032 | History page (frontend) | done | 0 | FR-HIST-01–03, FR-HIST-06 | L | B-031 | List, insights, Recharts trends |
| B-033 | Admin API endpoints | done | 0 | FR-ADMN-01–05 | M | B-005 | Admin role check, health panel |
| B-034 | Admin page (frontend) | done | 0 | FR-ADMN-01–05 | M | B-033 | User mgmt, analysis log, health |
| B-035 | PDF report generation | done | 0 | FR-XPRT-02–03 | L | B-024 | WeasyPrint, HTML template, background job |
| B-036 | CSV data export | done | 0 | FR-XPRT-04, NFR-SECU-07 | S | B-004 | GDPR Article 20 |
...
| B-041 | E2E integration test | done | 0 | NFR-MAIN-04 | L | all | Full flow with fixture video |
| B-042 | CI pipeline (GitHub Actions) | done | 0 | NFR-MAIN-01, NFR-MAIN-05–06 | M | all | ruff, pyright, pytest, vitest, coverage |
